                    ...
                    if (rd.HasRows)
                    {
                        ...
                        switch (UserRoleId)
                        {
                            ...
                            case 9:
                                ...
                                adminid = HttpUtility.UrlEncode(HttpUtility.UrlEncode(Encrypt(UserRoleId.ToString()))) + "," + adminIds;
                                break;
                            case 7:
                            ...
                            case 3:
                                UserId = (Int32)rd["SubUserId"];
                                UserName = rd["UserName"].ToString();
                                UserEmail = rd["UserEmail"].ToString();
                                UserAdminId =(Int32)rd["AdminId"];
                                ...
                                adminIds = HttpUtility.UrlEncode(HttpUtility.UrlEncode(Encrypt(UserId.ToString())));
                                adminid = HttpUtility.UrlEncode(HttpUtility.UrlEncode(Encrypt(UserRoleId.ToString()))) + "," + adminIds;
                               // adminid = "3";
                                break;
                            case 10:
