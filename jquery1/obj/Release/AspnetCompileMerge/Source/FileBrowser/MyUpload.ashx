    ...
    public class MyUpload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                filename = file.FileName;//context.Request["qqfilename"];
                //pathToSave_100 = HttpContext.Current.Server.MapPath("~/MediaUploader/") + fileName;
                imagepath = "~/MediaUploader/"; // context.Request["dest"];
                cultureName = "En";// context.Request["culture"];
